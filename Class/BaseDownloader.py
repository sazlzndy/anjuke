...
class BaseDownloader(object):
    ...
    def CreateSourceHouseInfo(self):
        ...
        pdData = pd.read_sql_query("select HouseInfoId,TotalPrices FROM (select HouseInfoId,TotalPrices FROM houseinfo ORDER BY Id desc ) as a GROUP BY HouseInfoId ",engine)
